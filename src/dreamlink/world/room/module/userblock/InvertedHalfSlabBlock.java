...
public class InvertedHalfSlabBlock implements IUserBlock {

    private static final String stampType = "Inverted Half Slab Block";
    ...
    public String getStampType() {
        return InvertedHalfSlabBlock.stampType;
    }
        ...
        for(var ix = 0; ix < CubeFace.getSize(); ix += 1) {
            ...
            var terrainQuad = this.writeToTerrainMeshBufferQuad.set(
                Vector3fMaths.addComponent(
                    this.writeToTerrainMeshBufferPosition.set(position).add(0f, 0.5f, 0f),
                    orientationAxisID,
