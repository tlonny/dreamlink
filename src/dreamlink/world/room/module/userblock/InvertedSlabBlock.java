...
public class InvertedSlabBlock implements IUserBlock {

    private static final String stampType = "Inverted Slab Block";
    ...
    public String getStampType() {
        return InvertedSlabBlock.stampType;
    }
    ...
    public boolean canTransmitLight(CubeFace cubeFace) {
        return cubeFace != CubeFace.top || this.isTransmittingLight;
    }
    ...
    public boolean isCollision(
        ...
        var minPosition = this.isCollisionMinPosition.set(blockPosition).add(0, 0.5f, 0);
    ...
    public void writeToTerrainMeshBuffer(
        ...
        for(var ix = 0; ix < CubeFace.getSize(); ix += 1) {
            ...
            var terrainQuad = this.writeToTerrainMeshBufferQuad.set(
                this.writeToTerrainMeshBufferPosition.set(position).add(0, 0.5f, 0),
                Vector3fMaths.zero,
