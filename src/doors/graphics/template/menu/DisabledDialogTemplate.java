...
public class DisabledDialogTemplate extends AbstractMenuTemplate {

    public static DisabledDialogTemplate DISABLED_DIALOG_TEMPLATE = new DisabledDialogTemplate();
