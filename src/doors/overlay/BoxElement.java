...
public class BoxElement {
    ...
    public void batch(MeshBuffer meshBuffer) {
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderBottomLeft;
        spriteBuffer.position.set(this.position);
        spriteBuffer.batch(meshBuffer);

        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderBottomRight;
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderTopLeft;
        spriteBuffer.position.set(
            this.position.x, 
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderTopRight;
        spriteBuffer.position.set(
            this.position.x + dimensions.x - BORDER_SIZE, 
            this.position.y + dimensions.y - BORDER_SIZE
        );
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderBottom;
        spriteBuffer.position.set(
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderTop;
        spriteBuffer.position.set(
            this.position.x + BORDER_SIZE, 
            this.position.y + dimensions.y - BORDER_SIZE
        );
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderRight;
        spriteBuffer.position.set(
            this.position.x + dimensions.x - BORDER_SIZE,
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.borderLeft;
        spriteBuffer.position.set(
            this.position.x,
            this.position.y + BORDER_SIZE
        );
        ...
        spriteBuffer.texture = Game.OVERLAY_TEXTURE.solid;
